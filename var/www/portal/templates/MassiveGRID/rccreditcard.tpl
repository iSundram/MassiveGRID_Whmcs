...
{else}
    {if !$hasRemoteInput}
        <script>
            ...
            function initVisibilityDropdowns()
            {
                var paymentMethodSelected = jQuery('.paymethod-info input[name="ccinfo"]:checked').val();
                ...
                var billingAddressSelected = jQuery('#billingAddressChoice input[name="billingcontact"]:checked').val();
                if (billingAddressSelected === 'new') {
            ...
            function validateRCCreditCardInput(e)
            {
                var newOrExisting = jQuery('input[name="ccinfo"]:checked').val(),
                    submitButton = jQuery('#btnRCSubmit'),
                    cardType = null,
                    submit = true,
            ...
            jQuery(document).ready(function() {
                ccForm = jQuery('#formRCInvoicePayment');
                ccForm.on('submit', validateRCCreditCardInput);
    ...
    {/if}
    <form id="formRCInvoicePayment" method="post" action="rccreditcard.php" class="form-horizontal" role="form">
        ...
        <div class="row">
            <div class="col-md-7">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        {if $existingCards && count($existingCards) > 0}
                ...
                <div class="cc-details hidden">
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input type="tel" name="ccnumber" id="inputCardNumber" size="30"
                                   value="{if $ccnumber}{$ccnumber}{/if}"
                                   autocomplete="off"
                                   class="form-control newccinfo cc-number-field"
                    ...
                    {/if}
                    <div id="inputDescriptionContainer" class="form-group">
                ...
                <div class="form-group submit-container">
                    <div class="text-center">
                        <button type="submit" class="btn btn-primary btn-lg margin-top-5" id="btnRCSubmit" value="{$LANG.submitpayment}">
